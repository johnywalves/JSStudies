...
function setTasks(list) {
    ...
    tasks
        ...
        .map(function (task) {
            ...
            div.classList.add("task", "card", "p-2", "mb-2", "bg-white", "text-secondary");
...
window.onload = function () {
    ...
    localStorage.setItem("tasks", JSON.stringify([
        {
            "id": 1, "stageId": 1, "order": 3, "tags": [1, 2, 6],
            "title": "Avatar",
            "description": "<b>Directors:</b> James Cameron<br/>"
        },
        {
            "id": 2, "stageId": 2, "order": 2, "tags": [4, 5],
            "title": "Titanic",
            "description": "<b>Directors:</b> James Cameron<br/>"
        },
        {
            "id": 3, "stageId": 1, "order": 1, "tags": [1, 2, 3],
